...
void ColumnCache::setColumns(const QStringList& columns) {
    ...
    insertColumnNameByEnum(COLUMN_STEMSMIXTRACKSTABLE_TRACKID, STEMSMIXTRACKSTABLE_TRACKID);
    insertColumnNameByEnum(COLUMN_STEMSMIXTRACKSTABLE_STEMID, STEMSMIXTRACKSTABLE_STEMID);
    insertColumnNameByEnum(COLUMN_STEMSMIXTRACKSTABLE_POSITION, STEMSMIXTRACKSTABLE_POSITION);

    insertColumnNameByEnum(
            COLUMN_STEMSMIXTRACKSTABLE_DATETIMEADDED,
            STEMSMIXTRACKSTABLE_DATETIMEADDED);

    insertColumnNameByEnum(COLUMN_STEMSMIXTRACKSTABLE_ABSOLUTEBARINDEX, STEMSMIXTRACKSTABLE_ABSOLUTEBARINDEX);
    insertColumnNameByEnum(COLUMN_STEMSMIXTRACKSTABLE_TRACKBARINDEX, STEMSMIXTRACKSTABLE_TRACKBARINDEX);
    insertColumnNameByEnum(COLUMN_STEMSMIXTRACKSTABLE_DURATIONBARS, STEMSMIXTRACKSTABLE_DURATIONBARS);
    insertColumnNameByEnum(COLUMN_STEMSMIXTRACKSTABLE_STEMSMIXID, STEMSMIXTRACKSTABLE_STEMSMIXID);
